...
function () {
  ...
  _createClass(LocationApi, [{
    ...
    value: function getMyLocation(ip) {
      return fetch("https://ipapi.co/".concat(ip, "/json/")).then(function (response) {
        if (response.status === 200) {
          return response.json();
        }
...
function () {
  ...
  _createClass(Dom, [{
    ...
    key: "setInfoWeather",
    value: function setInfoWeather(obj) {
      this.cityDiv.innerText = obj.city;
      this.cloudinessDiv.innerText = "cloudiness: ".concat(obj.cloudiness, "%");
      this.weatherStatusDiv.innerText = obj.weatherStatus;
      this.tempDiv.innerText = "".concat(obj.temp, "\xB0C");
      this.humidityDiv.innerText = "humidity: ".concat(obj.humidity, "%");
      this.windDiv.innerText = "wind speed: ".concat(obj.wind, " m/s");
    }
  }, {
    key: "getCityValueFromInput",
    value: function getCityValueFromInput() {
...
function () {
  ...
  _createClass(Weather, [{
    ...
    value: function getWeather(cityName) {
      return fetch("https://api.openweathermap.org/data/2.5/weather?q=".concat(cityName, "&appid=12c7488f70bcd015f75b9a10d559d91f")).then(function (response) {
        if (response.status === 200) {
          return response.json();
        }
...
var _location_api = _interopRequireDefault(require("./location_api"));
...
var locationApi = new _location_api.default();
var dom = new _dom.default();
var weather = new _weather.default();

function getWeatherByCity(city) {
  dom.showPreloader();
  weather.getWeather(city || dom.getCityValueFromInput()).then(function (weatherInfo) {
...
function appStart() {
  dom.showPreloader();
  locationApi.getMyIp().then(function (ip) {
    return locationApi.getMyLocation(ip);
  }).then(function (city) {
...
appStart();
dom.findCityInput.addEventListener('keydown', function (key) {
  if (key.keyCode === 13) {
    getWeatherByCity();
  }
});
dom.findCityButton.addEventListener('click', function () {
  return getWeatherByCity();
});
},{"./location_api":"location_api.js","./dom":"dom.js","./weather":"weather.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
